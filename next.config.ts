        ...
        headers: [
          ...
          // - workers: same-origin service workers (PWA + firebase-messaging)
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.firebasestorage.app https://firebasestorage.googleapis.com",
              "font-src 'self'",
              "connect-src 'self' wss://*.pusher.com https://*.pusher.com https://*.googleapis.com https://*.firebaseio.com https://*.firebasestorage.app",
